...
const album_entity_1 = require("./dto/entities/album.entity"); // Asegúrate de que la ruta sea correcta
let AlbumsService = class AlbumsService {
    ...
    findAll() {
        return this.albumRepository.find({ relations: ['songs', 'artist'] });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const album = yield this.albumRepository.findOne({ where: { id }, relations: ['songs', 'artist'] });
            if (!album) {
    ...
    update(id, updateAlbumDto) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.albumRepository.update(id, updateAlbumDto);
            return this.findOne(id);
        });
    }
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.albumRepository.delete(id);
        });
    }
};
