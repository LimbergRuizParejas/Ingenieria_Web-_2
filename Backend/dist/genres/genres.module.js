...
const artist_entity_1 = require("../artists/entities/artist.entity"); // Asegúrate de importar el entity de Artist
const artists_module_1 = require("../artists/artists.module"); // Importa el módulo de Artists
let GenresModule = class GenresModule {
};
GenresModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([genre_entity_1.Genre, artist_entity_1.Artist]),
            artists_module_1.ArtistsModule, // Importa el módulo de Artists
        ],
