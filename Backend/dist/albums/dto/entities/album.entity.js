...
const artist_entity_1 = require("../../../artists/entities/artist.entity"); // Ajusta la ruta según la estructura
const song_entity_1 = require("../../../songs/entities/song.entity"); // Ajusta la ruta
