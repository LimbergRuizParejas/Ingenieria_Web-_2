...
const artist_entity_1 = require("../artists/entities/artist.entity"); // Importa la entidad Artist
...
AlbumsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([album_entity_1.Album, artist_entity_1.Artist])],
        controllers: [albums_controller_1.AlbumsController],
        providers: [albums_service_1.AlbumsService],
        exports: [typeorm_1.TypeOrmModule] // Exporta TypeOrmModule para que esté disponible en otros módulos
    })
], AlbumsModule);
