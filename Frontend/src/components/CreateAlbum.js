...
const CreateAlbum = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        console.log('Form data being sent:', { title, image, artistId });  // Añadir log para verificar los datos enviados

        try {
            const response = await axios.post('http://localhost:3001/albums', formData, {
                headers: {
